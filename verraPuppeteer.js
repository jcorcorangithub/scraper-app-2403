...
async function scrapePDF(){
  ///////////////////////////////////////////////////////////////////////////////////////////
  ///this was for programmitcally going to the page and clicking the search button to produce the pdf
  ///////////////////////////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////
    ...
    const response = 
    await fetch("https://registry.verra.org/uiapi/resource/resource/search?$skip=0&count=true&$format=pdf&$exportFileName=allprojects.pdf", {
      "headers": {
    ...
    // });
      ...
      // const fileNames = fs.readdirSync('/Users/jamescorcoran/Desktop/scraper-app-2403/downloads/verraPDF');
        ...
        //look to see if i can pass response.data into pdf reader 
        //then read the tables in the pdf 
        // const data = "/downloads/allprojects.pdf";
    
////////////this was how I was going to try to "direct the downloaded" pdf after clicking on the download icon
//////////////////////////////////////////////////////////////////////////////////////
    // const fileNames = fs.readdirSync('/Users/jamescorcoran/Desktop/scraper-app-2403/downloads/verraPDF');
    // const fileData = fs.readFileSync(`/Users/jamescorcoran/Desktop/scraper-app-2403/downloads/verraPDF/${fileNames[0]}`);
